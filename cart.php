...
if (isset($_GET['admin']) && $_GET['admin'] == 2) {
    echo '<div class="admin_wrapper">
            <a href="http://localhost/cart02/cart.php?admin=3">Edit Accounts</a><br />
            <a href="http://localhost/cart02/cart.php?admin=4">Edit Products</a><br />
            <a href="http://localhost/cart02/cart.php?admin=5">View Purchases</a>
          </div>';
}
...
<form name = "purchase" action="cart.php?checkout=1&close=1" method="POST">
  <input type="text" hidden name="mail" value="1">
  <input class="complete_purchase_button" type="submit" value="complete purchase">
</form>
</div>
<div>
  <div class="continue_shopping_link"><a href="cart.php?close=1">Continue Shopping!</a></div><!-- end .continue_shopping_link -->
